...
export function Skills() {
  const skillCategories = [
    ...
    },
    {
      title: 'Backend',
      icon: Server,
      skills: ['Node.js', 'Express', 'NestJS', 'REST APIs','Swagger','Microservices'],
      color: 'text-green-600',
    },
    {
      title: 'Database & ORM',
      icon: Database,
      skills: ['MongoDB', 'MySQL', 'PostgreSQL', 'TypeORM', 'Prisma'],
    ...
    //   title: 'Design & UX',
    //   icon: Palette,
    //   skills: ['Figma', 'Adobe XD', 'UI/UX Design', 'Prototyping', 'Wireframing', 'User Research'],
    //   color: 'text-pink-600',
    // },
  ];
